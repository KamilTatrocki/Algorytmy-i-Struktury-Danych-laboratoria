...
public class Main {
	...
	public static void main(String[] args) {
		...
		while(!halt) {
			...
			if(word[0].equalsIgnoreCase("onlyleft") && word.length==1) {
				if(currentDoc!=null)
					System.out.println(currentDoc.link.left());
				else
					System.out.println("no current document");
				continue;
			}
			...
			if(word[0].equalsIgnoreCase("inorder") && word.length==1) {
				if(currentDoc!=null)
					System.out.println(currentDoc.toStringInOrder());
				else
					System.out.println("no current document");
				continue;
			}
